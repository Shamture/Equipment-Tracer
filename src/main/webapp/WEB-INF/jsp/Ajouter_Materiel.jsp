            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form:form method="post" action="" modelAttribute="newMateriel" enctype="multipart/form-data" id="materiel-form">
                          ...
                          <div class="form-group">
                            <label>Image</label>
                            <form:input type="file" path="image" class="form-control" placeHolder = "Image"/>
                          </div>
                          <div class="form-group">
                            <label>Date Implementation ou derniere operation</label>
                            <form:input type="text" path="dernierMod" class="form-control datepicker" data-date-format="yyyy-mm-dd" placeHolder = "Date Implementation"/>
                          </div>
                          <div class="form-group">
                          ...
                          <br/><br/>
                          <input type="submit" class="btn btn-danger" value="Ajouter Materiel"/>
                        </form:form>
