                    ...
                    <div class="col-lg-12">
                        ...
                        <table class="table table-striped">
                           ...
                           <c:forEach items = "${requestScope.list }" var="item">
                           		<tr id="l${item.idUser }">
                           		   <td> <c:out value="${item.matricule }" /> </td>
                           		   <td> <c:out value="${item.nom }" /> </td>
                           		   <td> <c:out value="${item.prenom }" /> </td>
                           		   
                           		   <td> <button class="btn btn-danger delete-button" id="${item.idUser }"> <i class="fa fa-trash" ></i></button> </td>
                           		</tr>
                           </c:forEach>
                        </table>
	...
	<script>
	 $(function () {
	    	$('.delete-button').click(function() {
	    		  var idUser = this.id;
	    		  $.ajax({
	                  url : 'supprimer-utilisateur?id='+idUser,
