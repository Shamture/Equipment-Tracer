...
<meta charset="UTF-8">
<title>Ajouter Categorie Materiel</title>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form:form method="post" action="" modelAttribute="newCat"  id="materiel-form">
                          <div class="form-group">
                            <label>Nom Categorie : </label>
                            <form:input type="text" path="nom" class="form-control" placeHolder = "Nom Categorie"/>
                          </div>
                          ...
                          <br/><br/>
                          <input type="submit" class="btn btn-danger" value="Ajouter Categorie"/>
                        </form:form>
